...
def pagode():
    print()
    pagode=[{"Nome:": "Ferrugem", "cidade": "Rio de Janeiro", "Origem do apelido": "Ser ruivo","time":"Fluminense"}, {"Nome:": "Chico Buarque", "Época":"Ditadura militar","Time":"Fluminense","Agora eu era héroi":"João e Maria"}, {"Nome:": "Belchior", "Línguas":"Inglês, francês, espanhol, italiano e latim","morte":"aneurisma de aorta", "cidade-natal":"Sobral, Ceara"}]
    pontos = 0
